...
for disease in diseases:
    ...
    backup_file = os.path.join(project_root, f'app/data/{disease}_23feat_backup.csv')
    new_file = os.path.join(project_root, f'app/data/{disease}_historical_data_with_sanwater.csv')
